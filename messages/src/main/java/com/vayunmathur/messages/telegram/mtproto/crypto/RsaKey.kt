...
object RsaKey {
    ...
    private val TELEGRAM_PEM_KEYS = listOf(
        ...
        // Key 3 — legacy Telegram production key (fp 0xc3b42b026ce86b21, big-endian
        // 0x216be86c022bb4c3). Device shows current DC endpoints present ONLY this
        // fingerprint in resPQ, so it must remain in the set for selectKey to match.
